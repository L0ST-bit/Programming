    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->msgFrame, &QTextEdit::textChanged, this, &MainWindow::msgChanged);
...
void MainWindow::encodeMsg()
{
    if (!isLoaded) {
        ...
        usedBytes = ui->msgFrame->toPlainText().toUtf8().size();
        ...
        byteArray.push_back(ui->msgFrame->toPlainText().toUtf8());
...
void MainWindow::decodeMsg()
{
    if (!isLoaded) {
        ...
        ui->msgFrame->setText(QString::fromUtf8(byteArray));
